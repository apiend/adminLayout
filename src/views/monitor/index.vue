          ...
          <tr v-for="item in tableData">
            ...
            <td>
              <el-button
                type="primary"
                size="mini"
                @click="showAbnormal(item.projectName,item.projectId,item.taskEventName)"
              >查看
              </el-button>
              <el-button
                type="success"
                size="mini"
                @click="showHistory(item.projectId,item.projectName,item.taskEventName)"
              >
                记录
              </el-button>
              <el-button
                type="danger"
                size="mini"
                @click="handleDel(item.projectId,item.taskEventName)"
              >删除
              </el-button>
            </td>
          </tr>
