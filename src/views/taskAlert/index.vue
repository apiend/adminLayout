<template>
    <div>
        ...
        <div class="main-filter">
            <el-row>
                <el-col :span="4">
                    <select v-model="proId" class="selectDiv">
                ...
                <el-col :span="6">
                    <el-input placeholder="请输入关键字搜索任务" v-model="eventName"></el-input>
                </el-col>
                <el-col :span="2">
            ...
            <table class="table is-bordered is-striped is-fullwidth">
                ...
                <template v-for="item in tableData">
                    <tr>
                        ...
                        <td @click="extendTable(item)" style="cursor: pointer;">
                            <i class="el-icon-caret-bottom" v-show="!item.show"></i>
                            <i class="el-icon-caret-top" v-show="item.show"></i>
                        </td>
                    </tr>
        ...
        var result = {
            ...
            methods: {
                ...
                doExport(){
                    ...
                    const src = `${apihost}eventExecuteLog/export.do?proId=${that.proId}&stime=${stime}&etime=${etime}&eventName=${that.eventName}`
